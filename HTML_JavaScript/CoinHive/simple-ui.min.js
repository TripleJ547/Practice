...
(function(window) {
    ...
    Auth.prototype.showOptIn = function(callback) {
        ...
        this.iframe.src = CoinHive.CONFIG.AUTH_URL + "?key=" + this.siteKey + "&domain=" + encodeURIComponent(window.location.hostname) + "&theme=" + (
        this.params.theme || "light") + "&lang=" + (
...
(function(window) {
    ...
    var Miner = function(div) {
        ...
        var url = CoinHive.CONFIG.MINER_URL + "?key=" + params.key + "&user=" + encodeURIComponent(params.user || "") + "&whitelabel=" + (
            ...
            ? "1"
            : "0") + "&throttle=" + (
        params.throttle || "") + "&threads=" + (
        params.threads || "") + "&background=" + (
        params.background || "").replace(/#/g, "") + "&text=" + (
        params.text || "").replace(/#/g, "") + "&action=" + (
        params.action || "").replace(/#/g, "") + "&ref=" + (
        params.ref || "") + "&graph=" + (
